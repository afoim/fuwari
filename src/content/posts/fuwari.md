...
draft: false
image: https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/f286ef4d-326c-4c7c-8a1e-ed150937a12b.webp
lang: ""
...
3. ![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/2024-10-14-12-15-44-image.webp)![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/2024-10-14-12-17-03-image.webp)
...
1. 在根目录下的 `src` 文件夹中，你可以找到 `config.ts` 我们来开始改写
   ...
   - themeColor：hue值则是你的博客主题色，可以在你的博客右上角的画板图标确定喜欢的颜色再填写![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/2024-10-15-09-16-30-image.webp)
   ...
   - `NavBarConfig` 为导航栏设置的超链接。`ProfileConfig` 为你的用户的超链接，分别如图![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/2024-10-15-17-49-30-image.webp)
   ...
   - ![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/1ef05530-10fd-4301-af4e-21ddadf18605.webp)
   
   - ![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/da94494b-cc4b-4f07-ae95-8bf3b2f95d3c.webp)
...
7. 这也很简单，多亏了MarkText这款软件，我们也可以像编辑Typecho一样直接使用Ctrl+CV来在MarkDown语法中置入图片，但是我们需要一些小设置：
   ...
   - ![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/2024-10-14-12-54-21-image.webp)
...
1. 当你认为你的文章已经写得差不多时，想要看看效果？请到项目根目录执行：`pnpm dev`，稍等片刻，你就可以本地预览你的博客啦![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/2024-10-14-13-03-44-image.webp)
...
3. 此时，你的Github仓库应该已经有了新的提交![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/2024-10-14-13-10-12-image.webp)

#### 让Cloudflare连接上Github，使用Pages服务展示你的博客（FREE！）

1. 前往Cloudflare的 Workers 和 Pages 页面，创建一个新Pages![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/2024-10-14-13-14-28-image.webp)

2. 然后选择连接Git存储库，连接你的Github，随后设置构建命令：`pnpm build`  ，然后设置构建输出目录：`dist` ，如图![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/2024-10-14-13-16-15-image.webp)

3. 绑定自定义域，访问自定义域即可访问你的博客！![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/2024-10-14-13-17-00-image.webp)
