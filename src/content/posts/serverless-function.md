...
image: https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/serverless-function.png
tags:
  - Serverless
  - 云函数
draft: false
...
![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/serverless-function-1.png)
...
![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/serverless-function-2.png)

### [Render](https://render.com/)
![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/serverless-function-3.png)
**每月免费100G流量**，支持非常多的服务，如：静态网站、Web服务（Docker）、定时服务、PostgreSQL数据库、Key Vaule存储

唯一的缺点，性能不高

### [Zeabur](https://zeabur.com/zh-CN/)
![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/serverless-function-4.png)
**每月免费5刀额度** ，免费计划有两个地域可选
![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/serverless-function-5.png)

最重磅的在于你可以将自己的VPS托管给Zeabur，它会在你的服务器上安装k3s等服务，之后你就可以直接在Zeabur的仪表盘上进行运维了

**最小服务器要求：2GB 内存，1 核 CPU。**

![](https://cnb.cool/2x.nz/fuwari/-/git/raw/main/src/content/assets/images/serverless-function-6.png)
